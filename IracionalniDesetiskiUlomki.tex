...
%To nam daje motivacijo za posplošitev tega primera 
...
\[
    ...
    \end{split}
\]
Zgornji integral konvergira, zato bo tudi vrsta $\sum_1^{\infty}\frac{1}{e^{\sqrt{x}}}$ bo zato konvergentna in s tem bo konvergirala tudi $\sum_1^{\infty}\frac{1}{a_k}$.

V nadaljevanju bomo pokazali, da je $Dec\{a_k\}$ iracioanlno, tudi kadar $\{a_k\}$ narašča kot $e^{\sqrt{k}}$.
%% tu malo bolj poveži z besedilom
% podaj primer ki velja za posledico a ne velja za izrek

\begin{izrek}
    Naj bo $Dec\{a_k\} \in \Q$. Potem obstaja $x \in \R, \ x \ge 1$ in pozitivna konstanta $C$,
...
\begin{posledica}
    ...
    za vsak $y \ge 1$. Potem je decimalno število $Dec\{a_k\}$ iracionalno.
\end{posledica}
...
pogoj iz zgornje posledice $(\sum_{k=1}^{\infty}\frac{y^k}{a_k} = \infty , \ \forall y \ge 1)$.
