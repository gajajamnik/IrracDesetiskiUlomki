...
\klasifikacija{~} 
\izvlecek{V članku obravnavamo načine, kako iz zaporedja števk v decimalnem zapisu realnega števila lahko določimo njegovo racionalnost oziroma iracionalnost.
Podrobneje obravnavamo decimalno število s števkami, sestavljenimi iz zaporedja praštevil.}


%popravi prevod
\title{On some irrational decimal fractions}
\abstract{In the article we discuss how to decide the irrationality of a real number based on the properties of the sequence of its decimal expansions.
We closely look at a number that has sequence of prime numbers for its decimals.}
...
$(a_m)$ vsebovanih v prvi periodi, ostale števke pa v drugi. Če je število števk v $(a_m)$ večje kot $p$,
lahko blok $(a_m)$ pokriva tudi več period.
