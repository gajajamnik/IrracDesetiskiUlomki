...
\section{Zaključek}
V članku smo najprej s pomočjo Dirichletovega izreka dokazali, da je decimalno število
s števkami, sestavljenimi iz
zaporedja praštevil, iracionalno.
Nato smo spoznali nekaj kriterijev
za določitev iracionalnosti realnega števila,
o katerih si lahko več preberemo v \cite{Heg} in \cite{Mar}.
Uporabili smo jih na nekaj primerih za dokaz iracionalnosti števila, hkrati pa smo 
spoznali, da v določenih primerih kriteriji odpovejo.
Poleg navedenih kriterijev obstajajo še drugi, ki jih v članku nismo omenili,
primer takšnega je naveden v \cite{Mer}.
...
\begin{thebibliography}{1}
    \bibitem{Euc}
    J. P. Pinasco \emph{New Proofs of Euclid's and Euler's Theorems},
    Amer.~Math.~Monthly \textbf{116}  (2009), no. 2,  172-174.
    \bibitem{Vog}
    J.~Vogrinc, \emph{Dirichletov izrek in karakterizacija praštevil}, 
    Master's thesis, Fakulteta za matematiko in fiziko, Univerza v Ljubljani, Ljubljana, October 2013.
    \bibitem{Eul}
    ...
    Amer.~Math.~Monthly \textbf{100}  (1993), no. 8,  779-780.
    \bibitem{Mar}
    P.~Martinez, \emph{Some new irrational decimal fractions},
    Amer.~Math.~Monthly \textbf{108}  (2001), no. 3,  250-253.
    \bibitem{Mer}
    A.~McD.~Mercer, \emph{A note on some irrational decimal fractions},
    Amer.~Math.~Monthly \textbf{101}  (1994), no. 6,  567-568.
